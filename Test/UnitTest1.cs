    ...
    public class UnitTest1
    {
        public static object[][] TestCases = new[]
        {
            ...
            new object[]
            {
                ...
                new XDQuickBattleArguments(PlayerTeam.ミュウ, EnemyTeam.ラティアス, 357, 321, 289, 290),
        ...
        public void Test2()
        {
            ...
            var res = searcher.Next(new XDQuickBattleArguments(PlayerTeam.ミュウ, EnemyTeam.フリーザー, 340, 335, 309, 344));
            Assert.Equal(res, Array.Empty<uint>());
            res = searcher.Next(new XDQuickBattleArguments(PlayerTeam.ミュウ, EnemyTeam.ラティアス, 357, 321, 289, 290));
            Assert.Equal(res.OrderBy(_ => _), new uint[] { 0x9F297767, 0x51297767, 0x03297767 }.OrderBy(_ => _));
            res = searcher.Next(new XDQuickBattleArguments(PlayerTeam.レックウザ, EnemyTeam.サンダー, 347, 241, 321, 293));
